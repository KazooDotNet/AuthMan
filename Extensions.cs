...
namespace AuthMan
{
	public static class Extensions
	{
		public static IServiceCollection AddAuthentication(this IServiceCollection services,
			Action<AuthManOptions> action, Assembly assembly = null)
		{
			AddAuthentication(services, action, typeof(global::AuthMan.AuthMan), assembly);
			return services;
		}

		public static IServiceCollection AddAuthentication<TAuthMan>(this IServiceCollection services,
			Action<AuthManOptions> action, Assembly assembly = null)
		...
		private static void AddAuthentication(IServiceCollection services, Action<AuthManOptions> action, Type type,
			Assembly assembly)
		{
